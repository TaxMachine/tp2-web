...
public class HomeController : Controller
{
    ...
    {
        return View(_editors);
    }
    
    [Route("/search")]
    public IActionResult Search(string name)
    {
        var editor = _editors.FirstOrDefault(e => e.Name == name);
        if (editor == null)
        {
            return NotFound();
        }
